    ...
    <footer className="bg-gradient-to-br from-blue-900 via-blue-800 to-blue-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center gap-3 mb-4">
              <div className="bg-white p-2 rounded-lg">
                <Heart className="h-6 w-6 text-blue-900 fill-blue-900" />
              </div>
              <div className="flex flex-col">
                <span className="font-bold text-xl">LULA</span>
                <span className="text-sm text-blue-200">Let Us Live Association</span>
              </div>
            </div>
        ...
        <div className="border-t border-blue-700 pt-6 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-blue-200 text-sm">{t('footer.rights')}</p>
          <DropdownMenu>
